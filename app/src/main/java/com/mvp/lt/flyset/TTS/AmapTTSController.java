...
/**
 * 当前播报方式是队列模式。其原理就是依次将需要播报的语音放入链表中，播报过程是从头开始依次往后播报。
 * <p>
 */
public class AmapTTSController {

    private final String appId = "5a742de7";
    ...
    public void onSpeckTextToVice(String arg1) {
        if (wordList != null)
